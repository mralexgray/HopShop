...
{
	Brew *brew = [[Brew alloc] initWithDelegate:nil];
	NSArray *cmdLine = [brew buildCommandLine:BrewOperationInfo arguments:[NSA arrayWithObject:@"git"]];
...
{
	Brew *brew = [[Brew alloc] initWithDelegate:nil];
	NSArray *cmdLine = [brew buildCommandLine:BrewOperationInfo arguments:[NSA arrayWithObjects:@"git", @"grails", nil]];
